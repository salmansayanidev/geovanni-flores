            ...
            <div class="col-12">
                <div class="services-main">
                    <ul class="services-slider-area">
                        ...
                        <li class="service-area bg-theme-color">
                            <img class="service-img img-3" src="./assets/images/services-img-3.png" alt="">
                            <div class="service-text-area">
                                <h2 class="service-title">Senior <br> Eye Care</h2>
                                <a class="bnner-link" href="#">Book Now</a>
                            </div>
                        </li>
                        <li class="service-area bg-dusty-brown">

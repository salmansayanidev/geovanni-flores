                ...
                <div class="col-12 col-lg-5">
                    ...
                    <form id="msform" class="position-relative" action="">
                        ...
                        <div id="step-1" class="pro-detail-area lens position-relative step step-1 active ">
                            ...
                            <div class="">
                                <input class="d-none select-lens-radio next" type="radio" name="prescription_radio" id="prescription-radio">
                        ...
                        <div id="step-2" class="pro-detail-area lens position-relative step step-2">
                            ...
                            <div class="">
                                <input class="d-none select-lens-radio next" type="radio" name="customer_prescription" id="customer-or-prescription">
                        ...
                        <div id="step-3" class="pro-detail-area lens position-relative step step-3">
                            ...
                            <div class="mb-3">
                                <input class="d-none select-lens-radio next" type="radio" name="prescription_type" id="single-vision">
                            ...
                            <div class="mb-3">
                                <input class="d-none select-lens-radio next" type="radio" name="prescription_type" id="Progressive">
                            ...
                            <div class="">
                                <input class="d-none select-lens-radio next" type="radio" name="prescription_type" id="Flat-Top-or-Bifocal">
                                ...
                                <div class="pupillary-distance-radio-area">
                                    <div class="">
                                        <label class="pupillary-distance-label" for="pupillary-distance-one">
                                            <input checked class="pupillary-distance-radio" value="one_number" type="radio" name="pupillary_distance_radio" id="pupillary-distance-one">
                                            One Number
                                        </label>
                                    </div>
                                    <div class="d-flex justify-content-start align-items-center gap-5">
                                        <label class="pupillary-distance-label" for="pupillary-distance-two">
                                            <input class="pupillary-distance-radio" type="radio" value="two_number" name="pupillary_distance_radio" id="pupillary-distance-two">
                                            Two Numbers
                                        </label>
                                        <button class="question-mark-btn" type="button">
                                            <i class="fa-solid fa-circle-question"></i>
